...
-- TODO: Implement these keys into the mod config keys table
KEY_TAB = 9
KEY_KP_0			= 256
KEY_KP_1			= 257
KEY_KP_2			= 258
...
KEY_LSUPER = 311
KEY_RSUPER = 312
KEY_ALT = 400 -- NOTE: DONT USE THIS, Doesn't seem to work in the game
KEY_CTRL = 401 -- NOTE: DONT USE THIS, Doesn't seem to work in the game
KEY_SHIFT = 402 -- NOTE: DONT USE THIS, Doesn't seem to work in the game
KEY_BACKSPACE = 8
KEY_PERIOD = 46
KEY_SLASH = 47
KEY_SEMICOLON = 59
...
-- DO NOT use these for gameplay! -- Hmmmmm, still use it anyway
